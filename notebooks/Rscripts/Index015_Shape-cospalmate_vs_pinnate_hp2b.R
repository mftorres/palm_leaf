...
for(tree in 1:n_tree){
	...
	write.table(hp2b_postdist,"./Shape-cospalmate_vs_pinnate_hp2b_postdist.txt",sep="\t")
}
write.table(hp2b_postdist,"./Shape-cospalmate_vs_pinnate_hp2b_postdist.txt",sep="\t")
save.image("./Shape-cospalmate_vs_pinnate_hp2b.Rimage")
