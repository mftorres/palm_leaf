...
data_hp2b<-filter(data_pre, pinnate_binomial == "True" | entire_binomial == "True")
...
write.table(hp2b_postdist,"./Shape-pinnate_vs_entire_hp2b_postdist-1.txt",sep="\t")
save.image("./Shape-pinnate_vs_entire_hp2b-1.Rimage")
